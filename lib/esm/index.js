...
const createThemeContext = (themes, contextOptions) => {
    ...
    const Provider = (props) => {
        ...
        const [theme, setTheme] = useStateSafe(initialTheme ?? contextOptions.theme);
        return jsxRuntime$1.exports.jsx(ctx.Provider, { value: { theme, setTheme }, children: children });
    };
        ...
        return React.useMemo(() => {
            ...
            return {
                ...(contextOptions.theme === theme
                    ...
                    : merge_1({}, themes[contextOptions.theme], themes[theme])),
                theme,
                setTheme: c.setTheme,
            };
        }, [c, currentTheme]);
    ...
    const withoutThemeKeys = [...keys_1(themes[contextOptions.theme]), 'theme'];
