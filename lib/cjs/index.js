...
var root$8$1 = freeGlobal$3 || freeSelf$2 || Function('return this')();

var _root$2 = root$8$1;

var root$7$1 = _root$2;
...
var hasOwnProperty$9$2 = objectProto$c$1.hasOwnProperty;
 ...
 * of values.
 */
var nativeObjectToString$1$2 = objectProto$c$1.toString;
...
var _baseGetTag$2 = baseGetTag$6$1;
...
function baseIsArguments$1$2(value) {
  return isObjectLike$4$1(value) && baseGetTag$4$2(value) == argsTag$2$1;
}
...
var root$6$1 = _root$2;

/** Used to detect overreaching core-js shims. */
var coreJsData$1$2 = root$6$1['__core-js_shared__'];
...
var _getNative$2 = getNative$6$1;

var getNative$5$1 = _getNative$2,
    root$5$1 = _root$2;
...
var getNative$4$1 = _getNative$2;
...
/* Built-in method references that are verified to be native. */
var DataView$1$1 = getNative$3$2(root$3$2, 'DataView');
...
/* Built-in method references that are verified to be native. */
var Promise$2$1 = getNative$2$2(root$2$2, 'Promise');
...
/* Built-in method references that are verified to be native. */
var Set$1$1 = getNative$1$2(root$1$2, 'Set');
...
var dataViewCtorString$1 = toSource$4(DataView$2),
    mapCtorString$1 = toSource$4(Map$1$1),
    promiseCtorString$1 = toSource$4(Promise$1$1),
    setCtorString$1 = toSource$4(Set$2),
    weakMapCtorString$1 = toSource$4(WeakMap$1$1);
...
/** Used to convert symbols to primitives and strings. */
var symbolProto$2 = Symbol$1$2 ? Symbol$1$2.prototype : undefined;
...
/** Used as a reference to the global object. */
var root$8 = freeGlobal$2 || freeSelf$1 || Function('return this')();
...
/** Used to detect overreaching core-js shims. */
var coreJsData$1$1 = root$6['__core-js_shared__'];
...
var _getNative$1 = getNative$7;

var getNative$6 = _getNative$1,
    root$5 = _root$1;

/* Built-in method references that are verified to be native. */
var Map$3$1 = getNative$6(root$5, 'Map');
...
function baseIsArguments$1$1(value) {
  return isObjectLike$6$1(value) && baseGetTag$4$1(value) == argsTag$2;
}
...
/** Built-in value references. */
var propertyIsEnumerable$1 = objectProto$7$1.propertyIsEnumerable;
...
/* Built-in method references that are verified to be native. */
var DataView$1 = getNative$3$1(root$4$1, 'DataView');
...
/* Built-in method references that are verified to be native. */
var Promise$2 = getNative$2$1(root$3$1, 'Promise');
...
/* Built-in method references that are verified to be native. */
var Set$1 = getNative$1$1(root$2$1, 'Set');
...
/* Built-in method references that are verified to be native. */
var WeakMap$1 = getNative$8(root$1$1, 'WeakMap');
...
/** Used to detect maps, sets, and weakmaps. */
var dataViewCtorString = toSource$3(DataView),
    mapCtorString = toSource$3(Map$4),
    promiseCtorString = toSource$3(Promise$1),
    setCtorString = toSource$3(Set),
    weakMapCtorString = toSource$3(WeakMap$2);
...
function isIterateeCall$1(value, index, object) {
  ...
  if (type == 'number'
        ? (isArrayLike(object) && isIndex$2(index, object.length))
...
const createThemeContext = (themes, contextOptions) => {
    ...
    const Provider = (props) => {
        ...
        const [theme, setTheme] = useStateSafe(defaultTheme || contextOptions.theme);
        const handleTheme = React.useCallback((updatedState) => {
            setTheme((prevState) => {
        ...
        return jsxRuntime$1.exports.jsx(ctx.Provider, { value: { theme: controlledTheme || theme, setTheme: handleTheme }, children: children });
    };
    const useCtx = (currentTheme) => {
        ...
        return React__default["default"].useMemo(() => {
            ...
            return {
                ...(contextOptions.theme === theme ? themes[theme] : merge_1({}, themes[contextOptions.theme], themes[theme])),
                theme,
                setTheme: c.setTheme,
            };
        }, [c, currentTheme]);
    ...
    const withTheme = (options) => {
        return ((Component) => {
            const WithComponent = (props) => {
                ...
                return jsxRuntime$1.exports.jsx(Component, { ...rest, ...useTheme });
            };
            WithComponent.displayName = getComponentName(Component);
            return WithComponent;
        });
    };
    const withoutThemeKeys = [...keys_1(themes[contextOptions.theme]), 'theme', 'setTheme'];
    const withoutTheme = (rest, except) => {
        const without = withoutProperties(rest, withoutThemeKeys);
        return (Array.isArray(except) ? { ...without, ...pick_1(rest, except) } : without);
    };
